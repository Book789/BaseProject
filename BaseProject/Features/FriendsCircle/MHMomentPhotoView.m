...
- (void)bindViewModel:(MHMomentPhotoItemViewModel *)viewModel
{
    ...
    [self yy_setImageWithURL:viewModel.picture.bmiddle.url placeholder:nil];
    /// 设置
    /// 移除动画
...
//    /// 请求图片
//    @weakify(self);
//    [self yy_setImageWithURL:viewModel.picture.bmiddle.url
//                       placeholder:[UIImage imageNamed:@""]                           options:YYWebImageOptionAvoidSetImage
