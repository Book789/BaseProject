...
//字体
#define kMainFontSize(x)       [UIFont  fontWithName:@"PingFangSC-Medium" size:x]
#define kMainBoldFontSize(x)  [UIFont  fontWithName:@"PingFangSC-Semibold" size:x]
#define kMoneyFontSize(x)      [UIFont fontWithName:@"BebasNeue" size:x]
